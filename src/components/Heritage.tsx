...
const Heritage = () => {
    return (
        <section id="heritage" className="py-24 bg-surface-container-low">
            <div className="max-w-7xl mx-auto px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        className="space-y-8"
                    >
                        <h2 className="font-headline text-5xl font-bold text-primary leading-tight">Heritage in Every Jar</h2>
